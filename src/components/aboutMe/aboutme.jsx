          ...
          <div className="row justify-content-start align-items-center">
            ...
            <div className="offset-lg-1 col-lg-5">
              <div className="main_title text-left">
                ...
                <p>Experienced Full Stack Developer.A demonstrated history of working in the education management industry and
                  current experience of working in Conversational AI field.</p>
                <p>Skilled in all sort of languages and frameworks to have a strong core in full-stack development.
                Strong information technology professional with a B-tech focused in Computer Software Engineering from SRM University.</p>
